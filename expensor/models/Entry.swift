...
struct Company: Codable, Identifiable {
    ...
    init(id: String = UUID().uuidString, userId: String = "", name: String, cif: String) {
        self.id = id
        self.userId = userId
        self.name = name
        self.cif = cif
    ...
    init(from decoder: Decoder) throws {
        ...
        self.cif = try container.decode(String.self, forKey: .cif)
    }
}
...
struct ReceiptEntry: Identifiable, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, userId = "user_id", company, items, totals, taxes, date, category

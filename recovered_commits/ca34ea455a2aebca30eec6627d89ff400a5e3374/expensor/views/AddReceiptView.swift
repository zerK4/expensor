            ...
            Form {
                ...
                Section(header: Text("Items")) {
                    ...
                    HStack {
                        ...
                        if newReceipt.items.count > 1 {
                            Divider()
                                .frame(height: 20)
                                .padding(.horizontal, 8)
                            
                            Button(role: .destructive, action: {
                                if let lastIndex = newReceipt.items.indices.last {
                                    newReceipt.items.remove(at: lastIndex)
                                    calculateTotals()
                                }
                            }) {
                                Label("Remove Last Item", systemImage: "trash")
                                    .foregroundColor(.red)
                            }
                        }
                    }
                ...
                Section(header: Text("Payment")) {
                    VStack(spacing: 15) {
                        ...
                        HStack(spacing: 15) {
                            ...
                            Button(action: {
                                withAnimation {
                                    newReceipt.totals.paidCard = (newReceipt.totals.paidCard == nil) ? newReceipt.totals.total : nil
                                ...
                                .padding(.vertical, 12)
                                .background(newReceipt.totals.paidCard != nil ? Color.blue.opacity(0.2) : Color.gray.opacity(0.1))
                                .foregroundColor(newReceipt.totals.paidCard != nil ? .blue : .gray)
                                .cornerRadius(12)
                                .overlay(
                                    RoundedRectangle(cornerRadius: 12)
                                        .stroke(newReceipt.totals.paidCard != nil ? Color.blue : Color.gray.opacity(0.3), lineWidth: 1)
                                )
                            }
                            ...
                            Button(action: {
                                withAnimation {
                                    newReceipt.totals.paidCash = (newReceipt.totals.paidCash == nil) ? newReceipt.totals.total : nil
                                ...
                                .frame(maxWidth: .infinity)
                                .padding(.vertical, 12)
                                .background(newReceipt.totals.paidCash != nil ? Color.green.opacity(0.2) : Color.gray.opacity(0.1))
                                .foregroundColor(newReceipt.totals.paidCash != nil ? .green : .gray)
                                .cornerRadius(12)
                                .overlay(
                                    RoundedRectangle(cornerRadius: 12)
                                        .stroke(newReceipt.totals.paidCash != nil ? Color.green : Color.gray.opacity(0.3), lineWidth: 1)
                                )
                            }
                        }
                    }
